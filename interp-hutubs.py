...
def interp(args):
    print("="*30)
    print("    Interpolation Test: HUTUBS")
    print("="*30)
    ...
    save_dir = f'results/{args.exp_name}/test/hutubs-interp/{args.epoch}'
    plot_dir = f'results/{args.exp_name}/test/hutubs-interp/{args.epoch}/plot'
    errr_dir = f'results/{args.exp_name}/test/hutubs-interp/{args.epoch}/error'
...
if __name__ == "__main__":
    ...
    parser.add_argument('--test_fold', type=int, default=3, help='k for test')
